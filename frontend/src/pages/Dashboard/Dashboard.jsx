...
const Dashboard = () => {
 // Mock dashboard statistics
  ...
  const { data: recentEvents } = useQuery({
    ...
    queryFn: async () => [
      { id: 1, camera: 'Entrance Cam 1', object: 'Person', timestamp: '2023-12-01 10:30:15', confidence: 0.95, severity: 'high' },
      { id: 2, camera: 'Parking Cam 2', object: 'Car', timestamp: '2023-12-01 10:28:42', confidence: 0.87, severity: 'medium' },
      { id: 3, camera: 'Gate Cam 3', object: 'Truck', timestamp: '2023-12-01 10:25:33', confidence: 0.92, severity: 'low' },
      { id: 4, camera: 'Warehouse Cam 1', object: 'Person', timestamp: '2023-12-01 10:22:18', confidence: 0.89, severity: 'high' },
      { id: 5, camera: 'Perimeter Cam 4', object: 'Vehicle', timestamp: '2023-12-01 10:20:05', confidence: 0.78, severity: 'medium' },
    ],
  });
