...
urlpatterns = [
    ...
    path('video/analyze/', views.VideoAnalysisView.as_view(), name='video-analyze'),
...
urlpatterns += [
    ...
    path('cameras/<uuid:pk>/zones/', views.CameraZonesView.as_view(), name='camera-zones'),
    path('cameras/<uuid:pk>/lines/', views.CameraLinesView.as_view(), name='camera-lines'),
    path('cameras/<uuid:pk>/rules/', views.CameraRulesView.as_view(), name='camera-rules'),
    path('cameras/<uuid:pk>/events/', views.CameraEventsView.as_view(), name='camera-events'),
    path('cameras/<uuid:pk>/video-files/', views.CameraVideoFilesView.as_view(), name='camera-video-files'),
    
    # Rule-specific endpoints
    path('rules/<uuid:pk>/events/', views.RuleEventsView.as_view(), name='rule-events'),
    path('rules/<uuid:pk>/test/', views.RuleTestView.as_view(), name='rule-test'),
    
    # Event-specific endpoints
    path('events/<uuid:pk>/resolve/', views.EventResolveView.as_view(), name='event-resolve'),
    path('events/<uuid:pk>/clip/', views.EventClipView.as_view(), name='event-clip'),
    
    # Video file-specific endpoints
    path('video-files/<uuid:pk>/clips/', views.VideoFileClipsView.as_view(), name='videofile-clips'),
    path('video-files/<uuid:pk>/download/', views.VideoFileDownloadView.as_view(), name='videofile-download'),
    
    # Clip-specific endpoints
    path('clips/<uuid:pk>/annotations/', views.ClipAnnotationsView.as_view(), name='clip-annotations'),
    path('clips/<uuid:pk>/download/', views.ClipDownloadView.as_view(), name='clip-download'),
]