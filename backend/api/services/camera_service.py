...
class CameraService:
    """Класс сервиса для обработки бизнес-логики, связанной с камерами"""
    
    @staticmethod
    def get_cameras_with_stats(user: User) -> List[Dict[str, Any]]:
        """Получить камеры со статистикой для дашборда"""
